            ...
            <div className="flex flex-row items-start justify-between self-stretch lg:max-w-[1055px]">
              <div className="flex-col gap-2">
                ...
                <p className="flex items-center justify-center gap-[13px] pb-4 pt-10 text-lg leading-relaxed text-neutral-400">
                  ما همیشه آماده پاسخگویی به سوالات، پیشنهادات و انتقادات شما عزیزان هستیم. تیم پشتیبانی خوارزم با تجربه
                  و تخصص کافی، آماده ارائه بهترین خدمات به شما است.
                </p>
                <p className="flex items-center justify-center gap-[13px] py-4 text-lg leading-relaxed text-neutral-400">
                  شما می‌توانید از طریق راه‌های مختلف ارتباطی با ما در تماس باشید. تیم ما در ساعات کاری آماده پاسخگویی به
                  شما است و در اسرع وقت به پیام‌های شما پاسخ خواهیم داد.
                </p>
                <p className="flex items-center justify-center gap-[13px] py-4 text-lg leading-relaxed text-neutral-400">
                  برای ارسال پیام، شکایت، پیشنهاد یا هر گونه سوال، می‌توانید از فرم تماس استفاده کنید یا مستقیماً با
                  شماره‌های تماس ما در ارتباط باشید.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-muted/30 p-8 rounded-lg">
              ...
              <p className="text-muted-foreground mb-6">
                برای ارسال سوالات، پیشنهادات یا انتقادات خود، فرم زیر را تکمیل کنید. کارشناسان ما در اسرع وقت با شما
                تماس خواهند گرفت.
              </p>
